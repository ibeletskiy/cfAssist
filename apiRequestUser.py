...
request_type = "user.info?"
name = "handles=" + handle
apikey = "apiKey=3903987c32a6af46fed7cfee7d37489cd9f069d8"
unixtime = "time=" + str(int(time.time()))
rand = str(random.randint(100000, 999999))
tohash = rand + "/" + request_type + apikey + "&" + name + "&" + unixtime + "#" + "8ed6e456285870873788e878a9f1001b478ebc1a"
apisecret = "apiSig=" + rand + str(hashlib.sha512(tohash.encode()).hexdigest())

final = request_header + request_type + name + "&" + apikey + "&" + unixtime + "&" + apisecret
